...
export default function SignUpPage() {
  ...
  const validate = () => {
    ...
    if (!formData.email.trim()) {
      ...
      newErrors.email =
        "Must be a valid @students.unilorin.edu.ng email address";
      isValid = false;
    }
  ...
  return (
    <div className="min-h-screen bg-[#e2e8f0] flex flex-col p-4 selection:bg-unilorin-gold selection:text-unilorin-blue font-sans">
          ...
          <div className="p-8 pt-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500">
                  Use your Unilorin student email.
                </p>
                {errors.email && (
            ...
            <div className="mt-8 text-center text-sm text-gray-600">
              ...
              <Link
                href="/login"
                className="font-semibold text-unilorin-blue hover:underline"
              >
                Log In
              </Link>
            </div>
